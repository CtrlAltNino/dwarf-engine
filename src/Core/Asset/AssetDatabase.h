...
namespace Dwarf {
  ...
  private:
    ...
    template<typename T>
    static AssetReference<T> CreateAssetReference(
  ...
  public:
    ...
    static void Rename(std::filesystem::path const& from,
                       std::filesystem::path const& to);

    static void RenameDirectory(std::filesystem::path const& from,
                                std::filesystem::path const& to);
    ...
    static void AddShaderWatch(std::filesystem::path const& shaderAssetPath,
                               Ref<Shader> shader)
    {
