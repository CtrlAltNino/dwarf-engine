...
#include "Core/Asset/ModelFileHandler.h"
#include "Core/Asset/MaterialFileHandler.h"
...
namespace Dwarf {
    ...
    struct MeshAsset {
        ...
        void Load(){
            ...
            meshes = ModelFileHandler::Import(this->path);
            loaded = true;
        }
    ...
    struct MaterialAsset {
        ...
        void Load(){
            // Use Mesh Importer with meta data to import mesh
            material = MaterialFileHandler::Deserialize(this->path);
        }
