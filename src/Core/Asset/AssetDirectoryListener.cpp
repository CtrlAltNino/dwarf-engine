...
namespace Dwarf
{
    ...
    void AssetDirectoryListener::handleFileAction(efsw::WatchID watchid, const std::string &dir, const std::string &filename, efsw::Action action, std::string oldFilename)
    {
        ...
        case efsw::Actions::Modified:
            ...
            if (path.has_extension() && path.extension() != AssetMetaData::META_DATA_EXTENSION)
            {
                ...
                case ASSET_TYPE::MATERIAL:
                {
                    ...
                    AssetDatabase::AddShaderToRecompilationQueue(mat->GetAsset()->m_Material->GetShader());
                    break;
                }
