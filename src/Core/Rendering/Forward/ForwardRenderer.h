...
namespace Dwarf {
  ...
  public:
    ...
    void RenderIds(Ref<Scene> scene,
                   Ref<Camera> camera,
                   glm::ivec2 viewportSize) override;
    void RenderModelPreview(Ref<AssetReference<ModelAsset>> modelAsset,
                            Ref<Camera> camera,
                            glm::ivec2 viewportSize,
                            glm::quat rotation) override;
    void RenderMaterialPreview(Ref<AssetReference<MaterialAsset>> materialAsset,
                               Ref<Camera> camera,
                               glm::ivec2 viewportSize,
                               glm::quat rotation) override;
    ...
    Ref<RendererApi> GetRendererApi() override { return m_RendererApi; }
  };
}