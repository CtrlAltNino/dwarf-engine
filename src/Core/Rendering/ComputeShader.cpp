...
namespace Dwarf {
  ...
  Ref<IShaderParameter> ComputeShader::CreateComputeShaderParameter(
  ...
  template<>
  void ComputeShader::SetParameter<bool>(std::string_view identifier,
                                         bool value)
  {
  ...
  template<>
  void ComputeShader::SetParameter<unsigned int>(std::string_view identifier,
                                                 unsigned int value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void ComputeShader::SetParameter<float>(std::string_view identifier,
                                          float value)
  {
    if (m_Parameters.contains(identifier) &&
  ...
  template<>
  void ComputeShader::SetParameter<glm::vec2>(std::string_view identifier,
                                              glm::vec2 value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void ComputeShader::SetParameter<glm::vec3>(std::string_view identifier,
                                              glm::vec3 value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void ComputeShader::SetParameter<glm::vec4>(std::string_view identifier,
                                              glm::vec4 value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  void ComputeShader::SetParameter(std::string_view identifier,
                                   Ref<UID> value,
                                   ShaderParameterType type)
  {
    if (m_Parameters.contains(identifier) &&
