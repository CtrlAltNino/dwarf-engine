...
namespace Dwarf
{
  ...
  //   std::shared_ptr<IComputeShader> IComputeShader::s_PropagationShader =
  //   nullptr; std::shared_ptr<IComputeShader>
  //   IComputeShader::s_FinalizationShader =
  //     nullptr;

  //   std::shared_ptr<IComputeShader>
  //   IComputeShader::Create()
  //   {
  ...
  //   std::filesystem::path
  //   IComputeShader::GetOutlineShaderPath()
  //   {
  //     switch (Renderer::GetAPI())
  //     {
  //       using enum GraphicsApi;
  ...
  //         s_FinalizationShader =
  //         OpenGLComputeShader::CreateFinalizationShader();
  //         s_PropagationShader =
  //         OpenGLComputeShader::CreatePropagationShader(); break;
  ...
  // IComputeShader::CreateComputeShaderParameter(ShaderParameterType type)
  // {
  //   switch (type)
  //   {
  ...
  template<>
  void
  IComputeShader::SetParameter<bool>(std::string_view identifier, bool value)
  {
  ...
  template<>
  void
  IComputeShader::SetParameter<int>(std::string_view identifier, int value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void
  IComputeShader::SetParameter<unsigned int>(std::string_view identifier,
                                             unsigned int     value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void
  IComputeShader::SetParameter<float>(std::string_view identifier, float value)
  {
    if (m_Parameters.contains(identifier) &&
  ...
  template<>
  void
  IComputeShader::SetParameter<glm::vec2>(std::string_view identifier,
                                          glm::vec2        value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void
  IComputeShader::SetParameter<glm::vec3>(std::string_view identifier,
                                          glm::vec3        value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void
  IComputeShader::SetParameter<glm::vec4>(std::string_view identifier,
                                          glm::vec4        value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  void
  IComputeShader::SetParameter(std::string_view     identifier,
