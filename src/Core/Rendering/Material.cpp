...
namespace Dwarf {
  ...
  template<>
  void Material::SetParameter<unsigned int>(std::string_view identifier,
                                            unsigned int value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void Material::SetParameter<glm::vec2>(std::string_view identifier,
                                         glm::vec2 value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void Material::SetParameter<glm::vec3>(std::string_view identifier,
                                         glm::vec3 value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  template<>
  void Material::SetParameter<glm::vec4>(std::string_view identifier,
                                         glm::vec4 value)
  {
    if (m_Parameters.contains(identifier) &&
        (m_Parameters[std::string(identifier)]->GetType() ==
  ...
  void Material::SetParameter(std::string_view identifier,
                              Ref<UID> value,
