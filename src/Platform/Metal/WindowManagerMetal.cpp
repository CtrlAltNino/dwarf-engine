...
namespace Dwarf {
    ...
    WindowManagerMetal::WindowManagerMetal(Ref<InputManagerOpenGL> inputManager) : inputManager(inputManager) {
    ...
    Ref<IRenderTexture> WindowManagerMetal::AddRenderTexture(){
