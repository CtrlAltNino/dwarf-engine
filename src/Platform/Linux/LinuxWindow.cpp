...
namespace Dwarf
{
    ...
    LinuxWindow::LinuxWindow(const WindowProps &props) : m_Api(props.Api)
    {
        Init(props);
    }
    ...
    GraphicsApi LinuxWindow::GetApi()
    {
        return m_Api;
    }
    ...
    void LinuxWindow::SetWindowTitle(std::string windowName)
    {
