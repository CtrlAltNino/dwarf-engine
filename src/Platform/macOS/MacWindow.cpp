...
namespace Dwarf {
    ...
    MacWindow::MacWindow(const WindowProps& props) : m_Api(props.Api) {
        Init(props);
    }
    ...
    void MacWindow::SetWindowTitle(std::string windowName){
