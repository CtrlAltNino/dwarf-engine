...
namespace Dwarf {
  ...
  public:
    ...
    static void WriteToFile(std::filesystem::path const& filePath,
    ...
    static void Copy(std::filesystem::path const& from,
                     std::filesystem::path const& to);

    static void Rename(std::filesystem::path const& oldPath,
