...
namespace Dwarf {
  ...
  void AssetBrowserWindow::LoadIcons()
  {
    ...
    m_TessellationControlShaderIcon =
      Texture::Create(iconPath / "tessellationControlShaderIcon.png");
    m_TessellationEvaluationShaderIcon =
      Texture::Create(iconPath / "tessellationEvaluationShaderIcon.png");
  ...
  bool CompareDirectoryEntries(std::filesystem::directory_entry const& d1,
  ...
  void AssetBrowserWindow::RenderDirectoryLevel(
  ...
  void AssetBrowserWindow::OpenPath(
